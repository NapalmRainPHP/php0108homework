...
<div class="acf-rpw-columns-3 acf-rpw-column-last">
	...
	if ( current_theme_supports( 'post-thumbnails' ) ) {
		...
		<div class="small">
			<?php
			parent::gtc( 'dth', __( 'Display Thumbnail', 'acf_rpw' ), array( 'display' => __( 'Display', 'acf_rpw' ) ), __( 'Needs to be set as post featured image.', 'acf_rpw' ) );
	...
	echo parent::gtc( 'rm', __( 'Display Readmore', 'acf_rpw' ), array( __( 'Readmore', 'acf_rpw' ) ) );
	?>
