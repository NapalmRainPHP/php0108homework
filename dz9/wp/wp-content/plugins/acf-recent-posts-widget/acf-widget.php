...
class ACF_Recent_Posts_Widget {
	...
	public function acf_rpw_plugin_page() {
		?>
		<div class="wrap">
			<h2><?php _e( 'ACF RPW: Settings', 'acf_rpw' ); ?><a href="http://wp-doin.com" target="_blank" rel="nofollow"><img style="height: 30px; vertical-align: middle;" src="<?php echo plugins_url( 'img/logo.png', __FILE__ ); ?>" /></a></h2>
			<hr />
			<form method="post" action="options.php"> 
				...
				<table class="form-table">
					<tr valign="top">
						<th scope="row"><?php _e( 'Disable missing ACF notice from the plugins page.', 'acf_rpw' ); ?></th>
						<td><input type="checkbox" name="hide_acf_notice" value="1" <?php checked( get_option( 'hide_acf_notice' ) ); ?> /></td>
					</tr>

					<tr valign="top">
						<th scope="row"><?php _e( 'Disable the shortcode button.', 'acf_rpw' ); ?></th>
